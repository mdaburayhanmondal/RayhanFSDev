...
const Error = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-5 text-center bg-[#161513]">
      ...
      <div className="z-10 flex flex-col items-center gap-y-6">
        ...
        <Link
          to="/"
          className="flex items-center gap-x-2 bg-white text-[#161513] px-8 py-3 rounded-full font-bold hover:bg-transparent hover:text-white border border-white transition-all duration-300 shadow-lg shadow-orange-500/10"
        >
          <MdHome size={20} />
          Back to Home
        </Link>
